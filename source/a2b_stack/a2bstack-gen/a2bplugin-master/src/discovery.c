...
#include "a2bstack/inc/a2b/stackctxmailbox.h"
...
#include "periphcfg.h"
#include "override.h"
#include "a2bstack/inc/a2b/audio.h"
    ...
    )
{
    ...
    if ( bddNodeObj->i2cI2sRegs.has_i2srate )
    {
        ...
        case A2B_ENUM_I2SRATE_4X_SFF:
            ...
            break;
        /* TODO:[A2B library] We need to handle the Reduced Rate (RRDIV) enumerated
...
{
    a2b_Bool 	bRet, bNetConfigFlag = A2B_FALSE, nFlgSupIdMatch = A2B_TRUE, nFlgGpioMatch = A2B_TRUE;
    a2b_UInt8 	wBuf[4u];
    a2b_UInt8 	rBuf[8u];
    a2b_HResult status = A2B_RESULT_SUCCESS;
