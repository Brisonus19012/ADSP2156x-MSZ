        ...
        a2b_I2cBusSpeed speed, A2B_ECB* ecb)
{
	...
	eTwiResult = adi_twi_SetPrescale (adi_twi_hDevice, 15u);
...
a2b_HResult a2b_pal_AudioInitFunc(A2B_ECB* ecb)
{
	...
	pCodecTxSportConfig->nSamplingRisingClkEdge = 1u;
